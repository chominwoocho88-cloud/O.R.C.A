# modules/orca/pipeline/pipeline.py
"""
...
from apps.orca.pipeline.agents import agent_analyst, agent_devil, agent_hunter, agent_reporter
...
def run_agent_pipeline(
    *,
    ...
    try:
        from orca.historical_context import build_market_features, get_market_historical_context
