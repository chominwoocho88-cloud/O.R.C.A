...
class OrcaPathsAliasTests(unittest.TestCase):
    ...
    def test_package_dir_is_orca_legacy_dir(self):
        ...
        from orca.paths import PACKAGE_DIR as A
    ...
    def test_mock_patch_compatibility(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("orca.paths.DATA_DIR", patched_path):
                from orca.paths import DATA_DIR
    ...
    def test_orca_and_jackal_callers_import_paths(self):
        ...
        from orca import state, persist, postprocess, research_report
        from jackal import hunter, scanner, tracker
